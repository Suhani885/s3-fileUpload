...
export const managerActivityDestroyMutation = (options?: Partial<Options<ManagerActivityDestroyData>>): UseMutationOptions<ManagerActivityDestroyResponse, AxiosError<ManagerActivityDestroyError>, Options<ManagerActivityDestroyData>> => {
    const mutationOptions: UseMutationOptions<ManagerActivityDestroyResponse, AxiosError<ManagerActivityDestroyError>, Options<ManagerActivityDestroyData>> = {
...
export const managerActivityRetrieveQueryKey = (options?: Options<ManagerActivityRetrieveData>) => createQueryKey('managerActivityRetrieve', options);

export const managerActivityRetrieveOptions = (options?: Options<ManagerActivityRetrieveData>) => {
    return queryOptions({
...
export const managerActivityUpdateMutation = (options?: Partial<Options<ManagerActivityUpdateData>>): UseMutationOptions<ManagerActivityUpdateResponse, AxiosError<ManagerActivityUpdateError>, Options<ManagerActivityUpdateData>> => {
    const mutationOptions: UseMutationOptions<ManagerActivityUpdateResponse, AxiosError<ManagerActivityUpdateError>, Options<ManagerActivityUpdateData>> = {
        mutationFn: async (localOptions) => {
...
export const managerReportListQueryKey = (options?: Options<ManagerReportListData>) => createQueryKey('managerReportList', options);

export const managerReportListOptions = (options?: Options<ManagerReportListData>) => {
    return queryOptions({
        queryFn: async ({ queryKey, signal }) => {
